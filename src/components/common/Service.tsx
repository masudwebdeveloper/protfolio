...
const services: IService[] = [
  {
    ...
    title: "Web Design",
    description:
      "Expert web design service creating visually stunning, user-friendly websites optimized for performance and maximum impact.",
    icon: responsive,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    title: "Back-End",
    description:
      "Powerful back-end development service building robust and scalable solutions to handle complex data processing and server-side functionalities efficiently.",
    icon: backEnd,
  },
  {
    id: 4,
    ...
    description:
      "Secure authentication service implementing advanced protocols and encryption methods to protect user data and ensure reliable access control for enhanced security.",
    icon: authentication,
  },
];
const Service = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-5 sm:gap-x-3 sm:mx-0 mx-2">
