...
const About = () => {
  return (
    <div
      id="about"
      className="flex flex-col-reverse md:flex-row gap-y-5 px-1 sm:px-2 md:px-5 lg:px-14 xl:px-24 sm:py-20 items-center py-4"
    >
      <img src={aboutImage} className="w-full md:w-2/5" alt="aboutIamge" />
      <div className="">
