  ...
  return (
    <div className="flex container mx-auto items-center gap-5 h-[70vh]">
      ...
      <div>
        ...
        <a href="https://" className="flex items-center bg-gradient-to-tr from-pink-500 to-violet-600 px-10 py-4 rounded-full mt-10 text-2xl font-medium text-white group sm:w-[250px]">
          Download cv
          <span>
