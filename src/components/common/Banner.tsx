...
const Banner = () => {
  return (
    <div className="container mx-auto flex items-center h-[100vh]">
      <div className="-mt-10">
        <h4 className="text-3xl font-medium text-gray-200 -mt-10 mb-4">
          Web Developer
        </h4>
        <h1 className="text-8xl font-bold text-gray-50 mb-10">Hey! I am</h1>
        ...
        <p className="text-2xl text-gray-300 mt-20">Follow Me:</p>
        <div className="mt-5 flex gap-x-5">
            <a target="_blank" href="#" className="w-14 h-14 rounded-full border-2 flex items-center justify-center">
                <FaFacebookF className="inline-block text-white text-2xl" />
            </a>
            <a target="_blank" href="#" className="w-14 h-14 rounded-full border-2 flex items-center justify-center">
                <FaLinkedinIn className="inline-block text-white text-2xl" />
            </a>
            <a target="_blank" href="#" className="w-14 h-14 rounded-full border-2 flex items-center justify-center">
                <FaInstagram className="inline-block text-white text-2xl" />
            </a>
            <a target="_blank" href="#" className="w-14 h-14 rounded-full border-2 flex items-center justify-center">
                <FaTwitter className="inline-block text-white text-2xl" />
            </a>
        </div>
      </div>
      <div className="">
