...
const SkillCard = ({ skill }: SkillType) => {
  ...
  return (
    <div className="group glass-effect text-center p-5 dark:bg-gradient-to-tr dark:from-gray-900 to-transparent backdrop-filter backdrop-blur-md shadow-md border-opacity-20 border border-white-20 rounded-lg transition duration-300 ease-in-out">
