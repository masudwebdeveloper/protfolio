...
const SkillCard = ({ skill }: SkillType) => {
  ...
  return (
    <div className="glass-effect group text-center p-5 group">
      <div className="w-14 h-14 flex items-center justify-center bg-gray-800 shadow-lg mx-auto rounded-full my-4 border-2 border-gray-700 group-hover:border-pink-600 duration-300 transition-all">
      ...
      <h2 className="uppercase text-3xl font-bold text-gray-200">
        {skill.name}
      </h2>
