...
const SkillCard = ({ skill }: SkillType) => {
  ...
  return (
    <div className="group text-center p-5 glass-effect bg-gradient-to-tr from-white-10 to-transparent backdrop-filter backdrop-blur-md shadow-md border-opacity-20 border border-white-20 rounded-lg transition duration-300 ease-in-out">
